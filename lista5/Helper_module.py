...
class TrainingClass:
  ...
  def __init__(self, model, device, loss_fn, optimizer, early_stopping=False, scheduler=None, patience=10, lr_patience=5):
    super().__init__()
  ...
  def training_loop(self, epochs, model_name, trainloader, validationloader, testloader):
    PATH = f'/content/drive/MyDrive/mlp-models/{model_name}_weights.pth'
    ...
    return test_loss, training_losses, validation_losses, train_metrics, validation_metrics, training_accuracies, validation_accuracies
